...
class LineZone:
    ...
    def __init__(self, start: Point, end: Point):
        ...
        self.white_count: int = 0  # white egg count
        self.brown_count: int = 0  # brown egg count
    ...
    def trigger(self, detections: Detections):
        ...
        for xyxy, confidence, class_id, tracker_id in detections:
            ...
            if not self.tracker_state.get(tracker_id):
                if class_id == 2:  # class_id 2 corresponds to white eggs
                    self.white_count += 1
                elif class_id == 0:  # class_id 0 corresponds to brown eggs
                    self.brown_count += 1
